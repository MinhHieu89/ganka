...
public static class GetOsdiAnswersHandler
{
    ...
    [
        (1, "Eyes that are sensitive to light?", "M\u1eaft nh\u1ea1y c\u1ea3m v\u1edbi \u00e1nh s\u00e1ng?", "Vision"),
        (2, "Eyes that feel gritty?", "M\u1eaft c\u1ea3m th\u1ea5y nh\u01b0 c\u00f3 c\u00e1t?", "Vision"),
        (3, "Painful or sore eyes?", "M\u1eaft \u0111au ho\u1eb7c r\u00e1t?", "Vision"),
        (4, "Blurred vision?", "Nh\u00ecn m\u1edd?", "Vision"),
        (5, "Poor vision?", "Th\u1ecb l\u1ef1c k\u00e9m?", "Vision"),
        (6, "Reading?", "\u0110\u1ecdc s\u00e1ch?", "Eye Symptoms"),
        (7, "Driving at night?", "L\u00e1i xe ban \u0111\u00eam?", "Eye Symptoms"),
        (8, "Working with a computer or bank machine (ATM)?", "L\u00e0m vi\u1ec7c v\u1edbi m\u00e1y t\u00ednh ho\u1eb7c m\u00e1y ATM?", "Eye Symptoms"),
        (9, "Watching TV?", "Xem ti vi?", "Eye Symptoms"),
